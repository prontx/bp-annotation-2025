...
import { playPause, selectClosestRedionsStarts, selectSkipLength, setTime, skipBy } from "../../player/redux/playbackSlice"
        ...
        switch (e.key) {
            ...
            case "ArrowRight":
                if (e.shiftKey){
                    ...
                    dispatch(skipBy({value: skipLength, changedBy: "controlsButton"}))
                }
                break
